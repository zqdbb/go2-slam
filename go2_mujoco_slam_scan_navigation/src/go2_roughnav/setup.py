...
setup(
    ...
    data_files=[
        ...
        (
            ...
            [
                ...
                "config/nav2_planner_params.yaml",
            ],
        ),
        (
            ...
            [
                ...
                "launch/integrated_navigation.launch.py",
            ],
        ),
        (
    ...
    entry_points={
        "console_scripts": [
            ...
            "odom_to_body_pose = go2_roughnav.odom_to_body_pose:main",
            "nav2_path_bridge = go2_roughnav.nav2_path_bridge:main",
            "nav2_lifecycle_activator = go2_roughnav.nav2_lifecycle_activator:main",
            "stuck_recovery = go2_roughnav.stuck_recovery:main",
        ],
    },
)
